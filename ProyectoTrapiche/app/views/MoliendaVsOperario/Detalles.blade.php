...
@section('Title')
<title>{{$Objeto->GetTextos()["Detallar"]["Legend"].$Objeto->GetNombreModelo()}}</title>
@stop

@section('body')

<h2>{{$Objeto->GetTextos()['Detallar']['Legend']. $Objeto->GetNombreModelo() }}</h2>
<div class="form-horizontal">
    ...
    {{Form::open(array('url'=>$Objeto->GetTextos()["Editado"]["NAMEURL"]))}}
   ...
   <div class="form-group">
    ...
    <div class="form-group">
        <div class="col-md-offset-2 col-md-10"> 
            {{Form::submit($Objeto->GetTextos()["Detallar"]["Legend"],$Objeto->GetTextos()["Detallar"]["AttrBtn"])}}
        </div>
    </div>
    {{Form::close()}}
