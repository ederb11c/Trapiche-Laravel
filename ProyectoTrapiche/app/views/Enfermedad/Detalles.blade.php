...
<div class="form-horizontal">
    {{Form::open(array('url'=>$EnfermedadSeleccionada->GetTextos()["Editado"]["NAMEURL"]))}}
    ...
    <div class="form-group">
        <div class="col-md-offset-2 col-md-10"> 
            {{Form::submit($EnfermedadSeleccionada->GetTextos()["Detallar"]["Legend"],$EnfermedadSeleccionada->GetTextos()["Detallar"]["AttrBtn"])}}
        </div>
    </div>
    {{Form::close()}}
</div>
