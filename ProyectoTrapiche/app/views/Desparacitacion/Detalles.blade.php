...
<div class="form-horizontal">
    {{Form::open(array('url'=>$DesparacitacionSeleccionada->GetTextos()["Editado"]["NAMEURL"]."/".$DesparacitacionSeleccionada->GetId()))}}
    ...
    <div class="form-group">
     ...
     <div class="form-group">
        <div class="col-md-offset-2 col-md-10"> 
           ...
           {{Form::submit($DesparacitacionSeleccionada->GetTextos()["Detallar"]["BtnName"],$DesparacitacionSeleccionada->GetTextos()["Detallar"]["AttrBtn"])}}
        </div>
    </div>
    {{Form::close()}}
