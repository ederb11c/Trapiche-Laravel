...
<div class="form-horizontal">
    {{Form::open(array('url'=>$HerrajeSeleccionado->GetTextos()["Eliminado"]["NAMEURL"]."/".$HerrajeSeleccionado->GetId()))}}
   ...
   <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-md-offset-2 col-md-10"> 
            {{Form::submit($HerrajeSeleccionado->GetTextos()["Eliminar"]["Legend"],$HerrajeSeleccionado->GetTextos()["Eliminar"]["AttrBtn"])}}
        </div>
    </div>
